...
import {
  utcFromDoyOrIso,
  convertDurationStringToPostgresInterval,
...
test('convertDurationStringToUs', () => {
  ...
  expect(convertDurationStringToUs('045T10:05:02.001')).toEqual(3924302001000);
...
test('convertDurationStringToInterval', () => {
  expect(convertDurationStringToPostgresInterval('2y 318d 6h 16m 19s 200ms 0us')).toEqual(
    '2 years 318 days 6 hours 16 minutes 19 seconds 200 milliseconds',
  );
  expect(convertDurationStringToPostgresInterval('1d 5h 23m 0s 300ms')).toEqual('1 day 5 hours 23 minutes 300 milliseconds');
  expect(convertDurationStringToPostgresInterval('1d -5h')).toEqual('19 hours');
  expect(convertDurationStringToPostgresInterval('- 5h 23m 0s 300ms')).toEqual('-5 hours -23 minutes -300 milliseconds');
  expect(convertDurationStringToPostgresInterval('30')).toEqual('30 microseconds');
  expect(convertDurationStringToPostgresInterval('001T00:01:00') ).toEqual('1 day 1 minute')
...
test('isTimeBalanced', () => {
  ...
  expect(isTimeBalanced('+001T12:43:20.000', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(isTimeBalanced('-09:04:00.340', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(isTimeBalanced('-001T23:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
  expect(isTimeBalanced('-365T23:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
  expect(isTimeBalanced('365T22:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
});
...
test('isTimeMax', () => {
  ...
  expect(isTimeMax('-365T23:59:60.999', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(isTimeMax('365T22:59:60.999', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
...
test('validateTime', () => {
  ...
  expect(validateTime('-001T23:59:60.000', TimeTypes.DOY_TIME)).toBe(false);
  expect(validateTime('365T23:59:60.000', TimeTypes.DOY_TIME)).toBe(true);
  expect(validateTime('-03:59:60.000', TimeTypes.DOY_TIME)).toBe(false);
  expect(validateTime('+03:59:60.000', TimeTypes.DOY_TIME)).toBe(false);
  expect(validateTime('03:59:60.190', TimeTypes.DOY_TIME)).toBe(true);
  expect(validateTime('2023-365T23:59:60', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
  expect(validateTime('2023-365T23:59:60', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
  expect(validateTime('-001T23:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(validateTime('365T23:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(validateTime('+03:59:60.000', TimeTypes.SIGNED_DOY_TIME)).toBe(true);
  expect(validateTime('3:59:60', TimeTypes.SIGNED_DOY_TIME)).toBe(false);
